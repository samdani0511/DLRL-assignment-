...
data = pd.read_csv('D:\\Antony2\\Acad\\Lec\\DLRL\\Datasets\\international-airline-passengers.csv',skipfooter=5) # The last 5 data was contaminated
data.head()
...
# model
model = Sequential()
model.add(LSTM(10, input_shape=(1, time_stamp))) # 10 lstm neuron(block)
model.add(Dense(1))
